...
s3_client = boto3.client(
    ...
    endpoint_url="http://minio-api-podman-ai-lab-rag-project1.apps.dell90b.tecaiocp.com",
    region_name="us-east-1"
)    

bucket_name = "micro-finance"
model_prefix = "flanT5-fine-tuned/"
local_model_dir = "/tmp/flan"
...
def home():
    print("Incoming request to / route:", request.method)
    prediction = None
    credit_score_category = None
    probability_non_default = None
    probability_default = None
